const TwitterIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14" className="text-gray-500">
    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.843L1.554 2.25h6.921l4.26 5.633 4.51-5.633zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z" />
  </svg>
);
