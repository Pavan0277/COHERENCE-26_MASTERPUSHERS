            ...
            <div className="section-container relative z-10 pt-24 pb-16 md:pt-32 md:pb-24">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        ...
                        >
                            Velo is the all-in-one CRM platform that captures
                            leads from every channel, nurtures them
                            automatically, and gives your team the tools to
                            ...
                            >
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[9px] text-body-light">
                                            Just now
                                        </p>
                                    </div>
                                </div>
